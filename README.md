...
- PostgreSQL 16+ (для хранения запросов)
...
export SPRING_DATASOURCE_URL=jdbc:postgresql://localhost:5432/telegram_bot
export SPRING_DATASOURCE_USERNAME=telegram_bot
export SPRING_DATASOURCE_PASSWORD=telegram_bot
```
...
spring.datasource.username=telegram_bot
spring.datasource.password=telegram_bot
```
...
Это запустит бота вместе с NATS и PostgreSQL в контейнерах.
